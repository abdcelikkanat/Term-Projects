...
run(subBatchSize=300, trainErrPeriod=1, eta=0.25, testErrPeriod=1, maxEpochNum=300,
    logfile='./log_pet_37class_fold4.txt', saveWeightsFor='train', saveWeightFile='./pet_37class_fold4.pkl')