...
run(subBatchSize=100, trainErrPeriod=1, eta=0.05, testErrPeriod=1, maxEpochNum=500,
    logfile='./log_pet_10class.txt', saveWeightsFor='train', saveWeightFile='./weights_pet_10class.pkl')