...
def run(subBatchSize=500, maxEpochNum=100, eta=0.1, trainErrPeriod=5, testErrPeriod=10,
    ...
    [layer8_extra, layer8_w_extra, layer8_b_extra] = my.fullyConnectedLayer(inputUnits=layer8,
                                                                            inputDim=64,
                                                                            outputDim=64
                                                                            )


    layer8 = layer8_extra.reshape((subBatchSize, 64))
    ...
    if loadweight is True and loadWeightFile is not None:
        with open(loadWeightFile, 'rb') as w:
            ...
            (param1, param2, param3, param4, param5, param6, param5_extra, param6_extra, param7, param8) = weights
            ...
            layer8_w_extra.set_value(param5_extra)
            layer8_w_extra.set_value(param6_extra)
    ...
    # Define parameters
    params = [layer1_w, layer1_b, layer4_w, layer4_b, layer8_w, layer8_b, layer8_w_extra, layer8_b_extra, layer9_w, layer9_b]
        ...
        if minErr > currentErr and saveWeightFile is not None:
            ...
            with open(saveWeightFile, 'wb') as w:
                pickle.dump((layer1_w.get_value(), layer1_b.get_value(),
                             ...
                             layer8_w_extra.get_value(), layer8_b_extra.get_value(),
                             layer9_w.get_value(), layer9_b.get_value()),
                            w, protocol=pickle.HIGHEST_PROTOCOL)


run(subBatchSize=100, trainErrPeriod=1, eta=0.08, testErrPeriod=1, maxEpochNum=300,
    logfile='./log_pet_extafully_10class.txt', saveWeightsFor='train', saveWeightFile='./weights_extrafully_pet_10class.pkl')