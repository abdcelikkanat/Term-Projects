...
def run(subBatchSize=500, maxEpochNum=100, eta=0.1, trainErrPeriod=5, testErrPeriod=10,
    ...
    [layer8, layer8_w, layer8_b] = my.dropoutLayer(inputUnits=layer7,
                                                   inputDim=32*6*6,
                                                   outputDim=64,
                                                   prob=0.5)
...
run(subBatchSize=100, trainErrPeriod=1, eta=0.05, testErrPeriod=1, maxEpochNum=300,
    logfile='./log_pet_dropout_10class.txt', saveWeightsFor='train', saveWeightFile='./weights_dropout_pet_10class.pkl')