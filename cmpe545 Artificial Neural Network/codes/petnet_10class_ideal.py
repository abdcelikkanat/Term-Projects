...
run(subBatchSize=100, trainErrPeriod=1, eta=0.19, testErrPeriod=1, maxEpochNum=300,
    logfile='./log_pet_10class_ideal2.txt', saveWeightsFor='train', saveWeightFile='./weights_pet_10class_ideal2.pkl')