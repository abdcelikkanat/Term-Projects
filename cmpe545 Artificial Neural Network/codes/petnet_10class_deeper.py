...
def run(subBatchSize=500, maxEpochNum=100, eta=0.1, trainErrPeriod=5, testErrPeriod=10,
    ...
    [layer7, layer7_w, layer7_b] = my.convolutionLayer(featureMaps=layer6,
                                                       featureMapShape=(subBatchSize, 32, 6, 6),
                                                       kernelShape=(64, 32, 3, 3)
                                                       )
    ...
    [layer10, layer10_w, layer10_b] = my.fullyConnectedLayer(inputUnits=layer9,
                                                             inputDim=64*2*2,
                                                             outputDim=64
                                                             )
    ...
    [error, numOfWrongClass, layer11_w, layer11_b] = my.softmaxLayer(inputVect=layer10,
                                                                     labels=y,
                                                                     inputDim=64,
                                                                     numOfClasses=10
                                                                     )
    ...
    if loadweight is True and loadWeightFile is not None:
        with open(loadWeightFile, 'rb') as w:
            ...
            (param1, param2, param3, param4, param5, param6, param7, param8, param9, param10) = weights
    ...
    # Define parameters
    params = [layer1_w, layer1_b, layer4_w, layer4_b, layer7_w, layer7_b, layer10_w, layer10_b, layer11_w, layer11_b]
...
run(subBatchSize=100, trainErrPeriod=1, eta=0.09, testErrPeriod=1, maxEpochNum=300,
    logfile='./log_pet_10class_deeper.txt', saveWeightsFor='train', saveWeightFile='./weights_pet_10class_deeper.pkl')