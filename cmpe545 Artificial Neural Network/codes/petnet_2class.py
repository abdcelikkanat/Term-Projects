...
run(subBatchSize=300, trainErrPeriod=1, eta=0.09, testErrPeriod=1, maxEpochNum=500,
    logfile='./log_pet_2class.txt', saveWeightsFor='train', saveWeightFile='./weights_pet_2class.pkl')