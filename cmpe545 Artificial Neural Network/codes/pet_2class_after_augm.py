...
def run(subBatchSize=500, maxEpochNum=100, eta=0.1, trainErrPeriod=5, testErrPeriod=10,
    ...
    my = myCNN()
    # Read dataset
    base = 'C:/Users/Abdulkadir/Desktop/Datasets/Pet Dataset/2class'
    trainSet_dir = base + '/'
    train_filename = ('subset1.pkl', 'subset2.pkl', 'subset2.pkl')
    (trainImages, trainLabels) = load_pet_dataset(trainSet_dir, train_filename)
    testSet_dir = base + '/'
    test_filename = ('subset4.pkl',)
    ...
    layer0 = x.reshape((subBatchSize, 3, 64, 64))
...
run(subBatchSize=300, trainErrPeriod=1, eta=0.09, testErrPeriod=20, maxEpochNum=250,
    logfile='./pet_2class_augmneted_log.txt', saveWeightsFor='train', saveWeightFile='./pet_2class_3set_only')